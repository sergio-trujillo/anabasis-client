...
export function MockExamPage() {
  ...
  if (!examQuery.data || examQuery.data.problems.length === 0) {
    return (
      <AppLayout>
  ...
  return <ExamRunner exam={examQuery.data} />;
}
...
type ExamData = NonNullable<ReturnType<typeof trpc.mock.buildExam.useQuery>["data"]>;
type ExamProblem = ExamData["problems"][number];
